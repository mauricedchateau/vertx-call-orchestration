...
public class SimpleMergeTest extends TestVerticle {
    private static final Logger LOG = LoggerFactory.getLogger(SimpleMergeTest.class);
    ...
    @Test
    public void simpleMergeRequest() {
